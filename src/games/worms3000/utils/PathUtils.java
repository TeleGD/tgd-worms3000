...
public class PathUtils {
	...
	public static String PersoRightRedWalk = Walk + "PersoRightRedWalk.png";

	public static String DiagD = OldTerrain + "DiagD.png";
	public static String DiagG = OldTerrain + "DiagG.png";
